...
const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    farmerName: 'Rajesh Kumar', farmerWallet: '0x4f2c...8b1d', currentStage: 'distribution',
  ...
  },
  {
    ...
    farmerName: 'Rajesh Kumar', farmerWallet: '0x4f2c...8b1d', currentStage: 'retail',
  ...
  },
  {
    ...
    farmName: 'Green Valley Farm', city: 'Nashik', state: 'Maharashtra', gpsCoordinates: '19.9975° N, 73.7898° E',
    farmerName: 'Rajesh Kumar', farmerWallet: '0x4f2c...8b1d', currentStage: 'consumer',
  ...
  },
  {
    ...
    farmName: 'Green Valley Farm', city: 'Nashik', state: 'Maharashtra', gpsCoordinates: '19.9975° N, 73.7898° E',
    farmerName: 'Rajesh Kumar', farmerWallet: '0x4f2c...8b1d', currentStage: 'processing',
...
const INITIAL_EVENTS: SupplyEvent[] = [
  { id: 'e1', batchId: 'CT-2024-0871', stage: 'farm', actorName: 'Rajesh Kumar', actorWallet: '0x4f2c...8b1d', location: 'Nashik, Maharashtra', timestamp: '2024-03-12T09:14:00Z', notes: 'Product registered, organic certified.', txHash: '0xabc...001', ipfsCid: 'QmA1...001' },
